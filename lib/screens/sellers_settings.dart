        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              title: const Text("Notifications"), // Changed from "Notification Preferences" to be more direct
              // The subtitle should reflect that it's an inbox, not a toggle preference
              subtitle: const Text("View your order notifications"),
              onTap: () {
                // Replace the toggle logic with navigation
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const SellersNotificationScreen(), // <--- THIS IS THE CORRECT NAVIGATION TARGET

                    // builder: (context) => NotificationService(), // <--- Navigate to your new screen
                  ),
                );
              },
            ),
