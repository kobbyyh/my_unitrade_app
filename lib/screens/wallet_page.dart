            ...
            child: Row(
              ...
              children: [
                _walletAction(Icons.arrow_downward, "Deposit", () {
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Deposit functionality Not Available Yet")));
                  // TODO: Implement Deposit functionality (e.g., navigate to a deposit screen)
                }),
                _walletAction(Icons.arrow_upward, "Withdraw", () {
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Withdraw functionality Not Available Yet")));
                  // TODO: Implement Withdraw functionality (e.g., navigate to a withdrawal screen)
                }),
                _walletAction(Icons.swap_horiz, "Transfer", () {
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Transfer functionality Not Available Yet")));
                  // TODO: Implement Transfer functionality (e.g., navigate to a transfer screen)
                }),
                _walletAction(Icons.person, "Referral", () {
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Referral functionality Not Available Yet")));
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                          return const Center(child: Text("Not Available Yet. We're Working On That"));
                        }
